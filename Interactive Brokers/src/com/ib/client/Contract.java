...
public class Contract implements Cloneable {
	...
	public String toString() {
		return "Contract [m_contractId=" + m_contractId + ", m_symbol=" + m_symbol
				...
				+ m_secIdType + ", m_secId=" + m_secId
				+ ", m_comboLegsDescrip=" + m_comboLegsDescrip
				+ ", m_comboLegs=" + m_comboLegs + ", m_underComp="
				+ m_underComp + "]";
	}
	...
	public Contract(int p_conId, String p_symbol, String p_secType,
			...
			String p_localSymbol, String p_tradingClass,
			Vector<ComboLeg> p_comboLegs, String p_primaryExch,
	...
	public boolean equals(Object p_other) {
		...
		if (!Util.NormalizeString(m_secType).equals("BOND")) {
			...
			if (Util.StringCompare(m_expiry, l_theOther.m_expiry) != 0
					...
					|| Util.StringCompare(m_tradingClass,
							l_theOther.m_tradingClass) != 0) {
				return false;
			}
		}
