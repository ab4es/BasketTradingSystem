...
public class Order {
	...
	public String toString() {
		return "Order [m_orderId=" + m_orderId + ", m_clientId=" + m_clientId
				...
				+ ", m_ocaGroup=" + m_ocaGroup + ", m_ocaType=" + m_ocaType
				+ ", m_orderRef=" + m_orderRef + ", m_transmit=" + m_transmit
				+ ", m_parentId=" + m_parentId + ", m_blockOrder="
				+ m_blockOrder + ", m_sweepToFill=" + m_sweepToFill
				+ ", m_displaySize=" + m_displaySize + ", m_triggerMethod="
				+ m_triggerMethod + ", m_outsideRth=" + m_outsideRth
				+ ", m_hidden=" + m_hidden + ", m_goodAfterTime="
				+ m_goodAfterTime + ", m_goodTillDate=" + m_goodTillDate
				+ ", m_overridePercentageConstraints="
				+ m_overridePercentageConstraints + ", m_rule80A=" + m_rule80A
				+ ", m_allOrNone=" + m_allOrNone + ", m_minQty=" + m_minQty
				+ ", m_percentOffset=" + m_percentOffset
				+ ", m_trailStopPrice=" + m_trailStopPrice
				+ ", m_trailingPercent=" + m_trailingPercent + ", m_faGroup="
				+ m_faGroup + ", m_faProfile=" + m_faProfile + ", m_faMethod="
				+ m_faMethod + ", m_faPercentage=" + m_faPercentage
				+ ", m_openClose=" + m_openClose + ", m_origin=" + m_origin
				+ ", m_shortSaleSlot=" + m_shortSaleSlot
				+ ", m_designatedLocation=" + m_designatedLocation
				+ ", m_exemptCode=" + m_exemptCode + ", m_discretionaryAmt="
				+ m_discretionaryAmt + ", m_eTradeOnly=" + m_eTradeOnly
				+ ", m_firmQuoteOnly=" + m_firmQuoteOnly + ", m_nbboPriceCap="
				+ m_nbboPriceCap + ", m_optOutSmartRouting="
				+ m_optOutSmartRouting + ", m_auctionStrategy="
				+ m_auctionStrategy + ", m_startingPrice=" + m_startingPrice
				+ ", m_stockRefPrice=" + m_stockRefPrice + ", m_delta="
				+ m_delta + ", m_stockRangeLower=" + m_stockRangeLower
				+ ", m_stockRangeUpper=" + m_stockRangeUpper
				+ ", m_volatility=" + m_volatility + ", m_volatilityType="
				+ m_volatilityType + ", m_continuousUpdate="
				+ m_continuousUpdate + ", m_referencePriceType="
				+ m_referencePriceType + ", m_deltaNeutralOrderType="
				+ m_deltaNeutralOrderType + ", m_deltaNeutralAuxPrice="
				+ m_deltaNeutralAuxPrice + ", m_deltaNeutralConId="
				+ m_deltaNeutralConId + ", m_deltaNeutralSettlingFirm="
				+ m_deltaNeutralSettlingFirm
				+ ", m_deltaNeutralClearingAccount="
				+ m_deltaNeutralClearingAccount
				+ ", m_deltaNeutralClearingIntent="
				+ m_deltaNeutralClearingIntent + ", m_deltaNeutralOpenClose="
				+ m_deltaNeutralOpenClose + ", m_deltaNeutralShortSale="
				+ m_deltaNeutralShortSale + ", m_deltaNeutralShortSaleSlot="
				+ m_deltaNeutralShortSaleSlot
				+ ", m_deltaNeutralDesignatedLocation="
				+ m_deltaNeutralDesignatedLocation + ", m_basisPoints="
				+ m_basisPoints + ", m_basisPointsType=" + m_basisPointsType
				...
				+ ", m_scaleTable=" + m_scaleTable + ", m_hedgeType="
				+ m_hedgeType + ", m_hedgeParam=" + m_hedgeParam
				+ ", m_account=" + m_account + ", m_settlingFirm="
				+ m_settlingFirm + ", m_clearingAccount=" + m_clearingAccount
				+ ", m_clearingIntent=" + m_clearingIntent
				+ ", m_algoStrategy=" + m_algoStrategy + ", m_algoParams="
				+ m_algoParams + ", m_whatIf=" + m_whatIf + ", m_notHeld="
				+ m_notHeld + ", m_smartComboRoutingParams="
				+ m_smartComboRoutingParams + ", m_orderComboLegs="
				+ m_orderComboLegs + ", m_orderMiscOptions="
				+ m_orderMiscOptions + "]";
	}
